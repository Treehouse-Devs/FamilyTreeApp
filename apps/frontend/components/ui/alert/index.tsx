...
const alertStyle = tva({
  base: 'items-center py-3 px-4 rounded-md flex-row gap-2 border-2 w-full',

  variants: {
    action: {
      error: 'bg-background-error border-error-500',
      warning: 'bg-background-warning border-warning-500',
      success: 'bg-background-success border-success-500',
      info: 'bg-background-info border-info-500',
      muted: 'bg-background-muted border-muted-500',
    },
