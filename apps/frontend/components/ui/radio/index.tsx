...
const radioIconStyle = tva({
  base: 'rounded-full justify-center items-center text-secondary-800 fill-secondary-800',
...
const radioIndicatorStyle = tva({
  base: 'justify-center items-center bg-transparent border-secondary-800 border-2 rounded-full data-[focus-visible=true]:web:outline-2 data-[focus-visible=true]:web:outline-secondary-800 data-[focus-visible=true]:web:outline data-[checked=true]:border-secondary-800 data-[checked=true]:bg-transparent data-[hover=true]:border-outline-500 data-[hover=true]:bg-transparent data-[hover=true]:data-[checked=true]:bg-transparent data-[hover=true]:data-[checked=true]:border-secondary-800 data-[hover=true]:data-[invalid=true]:border-error-700 data-[hover=true]:data-[disabled=true]:opacity-40 data-[hover=true]:data-[disabled=true]:border-secondary-800 data-[hover=true]:data-[disabled=true]:data-[invalid=true]:border-error-400 data-[active=true]:bg-transparent data-[active=true]:border-secondary-800 data-[invalid=true]:border-error-700 data-[disabled=true]:opacity-40 data-[disabled=true]:data-[checked=true]:border-secondary-800 data-[disabled=true]:data-[checked=true]:bg-transparent data-[disabled=true]:data-[invalid=true]:border-error-400',
  parentVariants: {
    size: {
      sm: 'h-4 w-4',
      md: 'h-5 w-5',
...
const radioLabelStyle = tva({
  base: 'text-secondary-600 data-[checked=true]:text-secondary-900 data-[hover=true]:text-secondary-900 data-[hover=true]:data-[disabled=true]:text-secondary-600 data-[hover=true]:data-[disabled=true]:data-[checked=true]:text-secondary-900 data-[active=true]:text-secondary-900 data-[active=true]:data-[checked=true]:text-secondary-900 data-[disabled=true]:opacity-40 web:select-none',
  parentVariants: {
    size: {
      '2xs': 'text-2xs',
      'xs': 'text-xs',
